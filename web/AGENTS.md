...
- **Framework**: Next.js 16.3.1 (App Router), React 19, TypeScript 5
...
## 4. Key File Map & Source of Truth
...
### A. Guest Checkout Policy (F001 Clarification)
...
- **Security & Integrity for Guest Bookings**:
  - The server (`/api/bookings`) must NEVER trust client-submitted prices or totals (see F006).
...
- Drivers have dedicated mobile-friendly route views (`/driver`).
